...
| Package | `npm run package` | Pass. 38 VSIX files, 14,598,586 bytes (13.92 MiB). Package reran all 41 tests and production builds. |
| Package SHA-256 | `Get-FileHash -Algorithm SHA256` | `36449B2936D27E0D1F60F5A46CF412077344498FF9CA70CDCAEEDE4767AC8823` |
