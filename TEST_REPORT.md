...
| Package | `npm run package` | Pass. 38 VSIX files, 14,598,745 bytes (13.92 MiB). Package reran all 41 tests and production builds. |
| Package SHA-256 | `Get-FileHash -Algorithm SHA256` | `D2306BFA6804570F2A1B7B59E94BCBB90EFFFABA92AEBE3629979E9FEAA9C1EA` |
